...
<body>
                    ...
                    <form method="post" action="store.php" name="form">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="no_ktp" placeholder="Masukkan No KTP Anda" name="no_ktp" required>
                            </div>
                            <!-- input ktp -->
                            <div class="mb-3">
                                <label for="no_telp" class="form-label">No Telp</label>
                                <input type="text" class="form-control" id="no_telp" placeholder="Masukkan No Telp Anda" name="no_telp" required>
                            </div>
                            <!-- input ktp -->
                            <div class="mb-3">
                                <label for="tahun_masuk" class="form-label">Tahun Masuk</label>
                                <input type="date" class="form-control" id="tahun_masuk" placeholder="Masukkan Tahun Masuk Anda" name="tahun_masuk" required>
                            </div>
                        </div>
    ...
    <!-- Table start  -->
    <div class="table-responsive data-karyawan mt-5">
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- aksi detail edit delete, btn-sm  -->
                            <!-- link untuk detail -->
