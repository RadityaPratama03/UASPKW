                ...
                <div class="card-body fw-bold">
                    ...
                    <form method="post" action="update.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_ktp" placeholder="Masukkan No KTP Anda" name="no_ktp" value="<?php echo $data['no_ktp']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="no_telp" class="form-label">No Telp</label>
                            <input type="text" class="form-control" id="no_telp" placeholder="Masukkan No Telp Anda" name="no_telp" value="<?php echo $data['no_telp']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="tahun_masuk" class="form-label">Tahun Masuk</label>
                            <input type="date" class="form-control" id="tahun_masuk" placeholder="Masukkan Tahun Masuk Anda" name="tahun_masuk" value="<?php echo $data['tahun_masuk']; ?>">
                        </div>
                        <!-- Button update data  -->
